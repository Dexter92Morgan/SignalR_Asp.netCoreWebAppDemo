...
connection.on("ResponseMessage", function (message) {
...
connection.start().catch(function (err) {
    ...
    //var connectionIds = localStorage.getItem('connectionId');
    //if (connectionIds) {
    //    // Reconnect to the hub using the connection id
    //    connection.start().then(function () {
    //        connection.invoke('Reconnect', connectionIds);
    //    }).catch(function (err) {
    //        return console.error(err.toString());
    //    });
    //} else {
    //    // Connect to the hub normally
    //    connection.start().catch(function (err) {
    //        return console.error(err.toString());
    //    });
    //}
